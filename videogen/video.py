...
def generate_subtitles(audio_path: str, sentences: List[str], directory: str, audio_clips: List[AudioFileClip], voice: str) -> str:
    """
    Generates subtitles from a given audio file and returns the path to the subtitles.
    ...
    # Save subtitles
    print(colored("[+] Saving subtitles...", "blue"))
    subtitles_path = f"{directory}/{uuid.uuid4()}.srt"
...
def generate_video(combined_video_path: str, tts_path: str, subtitles_path: str, threads: int, subtitles_position: str,  text_color : str) -> str:
    ...
    result.write_videofile("./output/output.mp4", threads=threads or 2)
